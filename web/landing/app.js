...
const translations = {
  en: {
    ...
    "other.aria": "Other tools by the author",
    "other.eyebrow": "Other tools",
    "other.title": "Need a tiny Discord role redemption bot?",
    "other.text": "<strong>Nobots</strong> lets members redeem keys for Discord roles. Small, file-based, and easy to deploy.",
    "other.button": "View Nobots",
    "support.aria": "Donate and community",
    "support.eyebrow": "Tiny support corner",
    "support.title": "Like my projects? Come say hi.",
  ...
  zh: {
    ...
    "other.aria": "作者的其他工具",
    "other.eyebrow": "看看我的其他工具",
    "other.title": "还需要一个轻量 Discord 兑换码发身份组工具吗？",
    "other.text": "<strong>Nobots</strong> 是一个小巧的 Discord 兑换码发身份组工具。文件化、好部署、容易改。",
    "other.button": "查看 Nobots",
    "support.aria": "投喂和社群",
    "support.eyebrow": "小小投喂角落",
    "support.title": "喜欢我的项目的话，来玩呀。",
