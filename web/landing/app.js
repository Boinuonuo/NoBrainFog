...
const translations = {
  en: {
    ...
    "hero.community": "Donate / Community",
    ...
    "features.manage.text": "Use commands like <code>/report</code>, <code>/done</code>, <code>/edit</code>, <code>/pri</code>, <code>/due</code>, and <code>/memo</code>.",
  ...
  zh: {
    ...
    "features.manage.text": "使用 <code>/report</code>、<code>/done</code>、<code>/edit</code>、<code>/pri</code>、<code>/due</code>、<code>/memo</code> 等指令管理任务。",
